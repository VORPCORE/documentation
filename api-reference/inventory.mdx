...
<Accordion icon="keyboard" iconType= "duotone" title="addWeaponComponent">
 
   <Icon icon="code" iconType="solid"/> add a component to a weapon
    ...
    <ParamField body="component" type="string | number" required>
     component name or hash
    </ParamField>

    <ParamField body="category" type="string | number" required>
     slot category
    </ParamField>
...
<Accordion icon="keyboard" iconType= "duotone" title="addWeaponComponents">
 
   <Icon icon="code" iconType="solid"/> add multiple components to a weapon
...
<Accordion icon="keyboard" iconType= "duotone" title="subWeaponComponent">
 
   <Icon icon="code" iconType="solid"/> remove a component from a weapon
...
<Accordion icon="keyboard" iconType= "duotone" title="subWeaponComponents">
 
   <Icon icon="code" iconType="solid"/> remove multiple components from a weapon
...
<Accordion icon="keyboard" iconType= "duotone" title="unRegisterUsableItem">
  ...
  <Accordion icon="keyboard" iconType= "duotone" title="removeItemFromCustomInventory">
   ...
   <Icon icon="code" iconType="solid"/> remove item from custom inventory
    ...
    <ParamField body="itemCraftedId" type="number" required>
      item crafted id
    </ParamField>
...
<Accordion icon="keyboard" iconType= "duotone" title="deleteCustomInventory">
 
   <Icon icon="code" iconType="solid"/> delete custom inventory from data base and cache
