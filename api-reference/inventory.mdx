...
<Accordion icon="keyboard" iconType= "duotone" title="getItemByName">
 
   <Icon icon="code" iconType="solid"/> get item amount by name
  ...
  <ParamField body="source" type="int" required>
    ...
    <ParamField body="return" type="table">
    returns a table containing the item info
    </ParamField>
    ```lua
...
<Accordion icon="keyboard" iconType= "duotone" title="getItemContainingMetadata">
 
   <Icon icon="code" iconType="solid"/> get item containing metadata
...
<Accordion icon="keyboard" iconType= "duotone" title="getItemMatchingMetadata">
 
   <Icon icon="code" iconType="solid"/> get item matching metadata
...
<Accordion icon="keyboard" iconType= "duotone" title="getItemByMainId">
  ...
  <ParamField body="source" type="int" required>
    ...
    <ParamField body="mainid" type="int" required>
    item main id
    </ParamField>
       <ParamField body="callback" type="function">
    callback function syncronous or asyncronous
    ...
    <ParamField body="return" type="table">
     `{id:number, label:string, name:string, metadata:table, group:number, type:string, count:number, limit:number,canUse:boolean}`
    </ParamField>
    ```lua
...
<Accordion icon="keyboard" iconType= "duotone" title="setItemMetadata">
   ...
   <Icon icon="code" iconType="solid"/> set item metadata
  ...
  <ParamField body="source" type="int" required>
    ...
    <ParamField body="metadata" type="table">
    `{ description:string?, image:string?}` **description** and **image** are reserved keys if they are not defined they will be ignored, image is the image name to apply
    </ParamField>
    <ParamField body="amount" type="int" required>
    amount of item
    </ParamField>
...
<Accordion icon="keyboard" iconType= "duotone" title="registerUsableItem">
  ...
  <ParamField body="item" type="string" required>
    ...
    <ParamField body="callback" type="function" required>
     callback `{source:int, id:number, label:string, name:string, metadata:table, group:number, type:string, count:number, limit:number,canUse:boolean}`
    </ParamField>
    ```lua
...
<Accordion icon="keyboard" iconType= "duotone" title="setCustomInventoryItemLimit">
   ...
   <Icon icon="code" iconType="solid"/> set custom inventory item limit
...
<Accordion icon="keyboard" iconType= "duotone" title="setCustomInventoryWeaponLimit">
         ...
         <Icon icon="code" iconType="solid"/> set custom inventory weapon limit
...
<Accordion icon="keyboard" iconType= "duotone" title="registerInventory">
  ...
  <ParamField body="data" type="table" required>
    ...
    <ParamField body="return" type="table">
    returns methods see modules/custominventory.lua
    </ParamField>
    ```lua
