...
<Tabs>
    ...
    <Tab title="Server Setters">
        ...
        <Accordion icon="code" iconType="duotone" title="SetDefaultDensityMultipliers">
            ...
            exports.vorp_lib:SetDefaultDensityMultipliers(target, "PedDensity", 0.0)
            ```
        </Accordion>
        ...
        <Accordion icon="code" iconType="duotone" title="SetTemporaryDensityMultipliers">
            ...
            ```lua
            local target <const> = source
            exports.vorp_lib:SetTemporaryDensityMultipliers(target, "ScenarioHumanDensity", 0.0)
            exports.vorp_lib:SetTemporaryDensityMultipliers(target, "RandomVehicleDensity", 0.1)
            exports.vorp_lib:SetTemporaryDensityMultipliers(target, "VehicleDensity", 0.2, 10)
            ```
        </Accordion>
