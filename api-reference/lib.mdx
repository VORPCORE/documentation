...
<Accordion icon="keyboard" iconType="duotone" title="Variables">
    <Tabs>
        <Tab title="server">
            ...
            <Accordion icon="keyboard" iconType="duotone" title="NOTIFY (server)">
        ...
        <Tab title="client">
            ...
            <Accordion icon="keyboard" iconType="duotone" title="NOTIFY (client)">
                `NOTIFY` is available for server and client , you wont need to use vorp core notify or even import the notify module
...
<Tabs>
    <Tab title="Client">
        <Accordion icon="code" iconType="duotone" title="Notify (client methods)">
    ...
    <Tab title="Server">
        <Accordion icon="code" iconType="duotone" title="Notify (server methods)">
